// Animated pill tab bar for the Prompt Package workspace.
...
const PromptTabBar: React.FC<PromptTabBarProps> = ({ tabs, active, onChange }) => (
  <div className="px-4 pt-4 pb-0">
    <LayoutGroup id="prompt-tabs">
