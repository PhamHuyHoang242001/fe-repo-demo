// Local hook for fetching and caching the caller's skill permissions.
...
import type { MySkillPermissions } from '../types';
import { myPermissions } from '../api/skillApi';

interface UseSkillPermissionsResult {
  data: MySkillPermissions | null;
  loading: boolean;
...
export function useSkillPermissions(): UseSkillPermissionsResult {
  const [data, setData] = useState<MySkillPermissions | null>(null);
