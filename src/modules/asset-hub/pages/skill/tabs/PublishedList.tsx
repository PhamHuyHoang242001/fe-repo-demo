...
import SkillToolbar, { SkillFilters } from '../components/SkillToolbar';
import SkillCard from '../components/SkillCard';
import { SkillCardSkeletonBlock } from '../components/Skeleton';
import { useInfiniteScroll } from '../hooks/useInfiniteScroll';
import { StaggerList, StaggerItem } from '../components/motion-primitives';
import { fadeInUp } from '../../../theme/motion';

const PAGE_LIMIT = 12;
type FiltersState = SkillFilters;
...
const EmptyState: React.FC = () => (
  ...
  >
    ...
    <p className="mt-5 text-sm font-bold text-ah-ink">Không tìm thấy skill nào</p>
...
const PublishedList: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-7">
      <SkillToolbar onFilterChange={handleFilterChange} count={total} />
      ...
      {!hasMore && !loading && items.length > 0 && (
        ...
        >
          Đã hiển thị tất cả {total} skill.
        </motion.p>
      )}
    </div>
  );
