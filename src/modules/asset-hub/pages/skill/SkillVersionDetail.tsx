...
import { approve, versionDetail } from './api/skillApi';
import type { SkillVersionDetail as Detail } from './types';
...
const SkillVersionDetail: React.FC = () => {
      ...
      >
        <div>
          <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-ah-muted">
            <Link to="/asset-hub/skill" className="hover:text-ah-green">
              Skill
            </Link>{' '}
            › Chi tiết phiên bản
          </div>
