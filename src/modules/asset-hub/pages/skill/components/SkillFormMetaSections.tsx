// Asset-hub metadata cards for SkillForm: ownership (publishing unit + people in charge) and the
// usage guide. Split out of SkillFormSections.tsx to keep both files focused and under the size
...
export const SkillTagField: React.FC<TagFieldProps> = ({ tagIds, setTagIds, selectedTags }) => (
  <Field label="Tags (tùy chọn)">
    <CatalogTagSelect artifactType="skill" value={tagIds} onChange={setTagIds} selectedTags={selectedTags} />
  </Field>
);
