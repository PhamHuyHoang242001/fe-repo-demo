          ...
          <Reveal>
            {safeMd ? (
              <div className="overflow-hidden rounded-2xl border border-ah-line bg-ah-card shadow-ah-float">
                {/* Editor-style header — traffic dots + mono filename signal a real skill file */}
                <div className="flex items-center gap-3 border-b border-ah-line bg-gradient-to-r from-ah-green-l via-ah-pale to-ah-card px-5 py-3">
                  ...
                  <span className="font-mono text-xs font-semibold tracking-tight text-ah-ink">SKILL.md</span>
